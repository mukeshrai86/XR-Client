...
@Component({
  selector: 'app-custome-dropdown-with-two-variabel',
  templateUrl: './custome-dropdown-with-two-variabel.component.html',
  styleUrls: ['./custome-dropdown-with-two-variabel.component.scss']
})
export class CustomeDropdownWithTwoVariabelComponent implements OnInit {
 public dropList:any;
 ...
 get selectedIn(): string {  
  ...
  this.bindNameFirst=this.config?.bindLabel[0]
  this.bindNamesecond=this.config?.bindLabel[1]
  }
