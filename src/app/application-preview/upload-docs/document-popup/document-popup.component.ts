/*
 @(C): Entire Software
 @Type: File, <TS>
 @Name: document-repopupsume.component.ts
 @Who: Renu
 @When: 20-June-2022
...
export class DocumentPopupComponent implements OnInit {
 ...
 @ViewChild('target') private myScrollContainer: ElementRef;
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,private fb: FormBuilder, public dialogRef: MatDialogRef<DocumentPopupComponent>,
  ...
  */
  ...
  checkDuplicity(checkforvalue) {
     ...
     if (checkforvalue == 'Name') {
      Value = this.addForm.controls['Name'].value?this.addForm.controls['Name'].value:this.fileName[0];
    }
    else {
