...
export class ManageSkillsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, public dialogRef: MatDialogRef<ManageSkillsComponent>, @Inject(MAT_DIALOG_DATA) public data: any,
    ...
    this.dropDownSkillTagsConfig['IsManage'] = '';
