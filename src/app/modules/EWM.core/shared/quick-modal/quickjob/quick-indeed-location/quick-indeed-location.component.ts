...
@Component({
  selector: 'app-quick-indeed-location',
  templateUrl: './quick-indeed-location.component.html',
  styleUrls: ['./quick-indeed-location.component.scss']
})
export class QuickIndeedLocationComponent implements OnInit {
 ...
 constructor(public dialogRef: MatDialogRef<QuickIndeedLocationComponent>, public dialog: MatDialog,
