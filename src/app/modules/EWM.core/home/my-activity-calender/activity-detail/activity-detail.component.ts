...
export class ActivityDetailComponent implements OnInit {
  ...
  sharedCanender:string=null;
  sharedCanenderPermission;
   /*
    @Type: File, <ts>
    @Name: constructor function
    @Who:renu
   ...
   */
  constructor(public dialogRef: MatDialogRef<ActivityDetailComponent>, public dialog: MatDialog,public _userpreferencesService: UserpreferencesService,
  ...
  this.sharedCanender =data.sharedCanender;
  this.sharedCanenderPermission = data.sharedCanenderPermission;
...
ViewActivity(acitivityInfo:any){
  document.getElementsByClassName("add_Manage")[0].classList.remove("animate__zoomIn")
  document.getElementsByClassName("add_Manage")[0].classList.add("animate__zoomOut");
  setTimeout(() => { this.dialogRef.close({isView:true, activityId:acitivityInfo.Id,acitivityInfo:acitivityInfo}); }, 200);
}
