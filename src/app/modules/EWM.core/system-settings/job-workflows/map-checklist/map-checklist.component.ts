...
@Component({
  selector: 'app-map-checklist',
  templateUrl: './map-checklist.component.html',
  styleUrls: ['./map-checklist.component.scss']
})
export class MapChecklistComponent implements OnInit {
  ...
  public newArray:any=[];
    constructor(public dialog: MatDialog,public dialogRef: MatDialogRef<MapChecklistComponent>, @Inject(MAT_DIALOG_DATA) public data: any,
    ...
    fetchAssessmentRecord(pagesize,pagneNo,sortingValue) { 
      this.jobWorkflowService.getGroupChecklistListDetails(pagesize, pagneNo, sortingValue,this.searchVal,this.filterConfig).subscribe(
