...
import { ConfirmDialogModel } from '@app/modules/EWM.core/job/screening/share-resume-internal/share-resume-internal.component';

@Component({
  selector: 'app-job-action-dialog',
  templateUrl: './job-action-dialog.component.html',
  styleUrls: ['./job-action-dialog.component.scss']
})
export class JobActionDialogComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<JobActionDialogComponent>,
