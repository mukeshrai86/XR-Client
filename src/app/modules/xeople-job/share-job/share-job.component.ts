...
import { PushCandidateSuccessPoupComponent } from '../job-screening/pushcandidate-to-eoh-from-popup/push-candidate-success-poup/push-candidate-success-poup.component';
...
export class ShareJobComponent implements OnInit {
  ...
  brandAppSetting: any=[];
  EOHLogo: any;
  constructor( public dialogRef: MatDialogRef<ShareJobComponent>,private pushCandidateEOHService: PushCandidateEOHService,
