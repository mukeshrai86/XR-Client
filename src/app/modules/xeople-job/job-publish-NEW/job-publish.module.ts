...
import { SeekUpdatePreviewPublishComponent } from './seek-update-preview-publish/seek-update-preview-publish.component';


@NgModule({
  declarations: [JobPublishComponent, JobPublishDetailsComponent, JobAddDetailsComponent, MapApplicationFormSeekComponent, RepublishJobComponent, SeekPostSubmitResponseComponent, BroadbeanComponent, JobIndeedComponent, JobIndeedDescriptionComponent, JobIndeedPublishedComponent, JobPublishIndeedDetailsComponent, SeekUpdateDetailsComponent, SeekUpdatePreviewPublishComponent],
  imports: [
    CommonModule,
...
export class JobPublishModulev1 { }
