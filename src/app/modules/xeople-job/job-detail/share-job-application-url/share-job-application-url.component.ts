...
import { AddRequiredAttendeesComponent } from '@app/modules/EWM.core/home/my-activity/add-required-attendees/add-required-attendees.component';
...
ngOnInit() {  
  ...
  this.shareJobApplicationUrl = this.applicationBaseUrl+'/job/desc?mode=apply&jobId='+this.JobId+domain+'&parentSource='+this.ParentSource+'&Source='+this.ParentSource;     
...
shareJobApplicationForm(){   
  ...
  this.userSelectedList.forEach(element=>{    
        SharedEmailIds.push(element.Email);  
  })
  ...
  this._Service.shareJobApplicationUrl(createPeopJson).subscribe(
