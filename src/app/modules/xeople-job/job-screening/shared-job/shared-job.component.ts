...
@Component({
  selector: 'app-shared-job',
  templateUrl: './shared-job.component.html',
  styleUrls: ['./shared-job.component.scss']
})
export class SharedJobComponent implements OnInit {
  ...
  constructor( public dialogRef: MatDialogRef<SharedJobComponent>,private pushCandidateEOHService: PushCandidateEOHService,
