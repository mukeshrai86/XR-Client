/*
  ...
  @What:  This page will be use for Activity  for job action
*/
...
@Component({
  selector: 'app-job-activity-create',
  templateUrl: './job-activity-create.component.html',
  styleUrls: ['./job-activity-create.component.scss']
})
export class JobActivityCreateComponent implements OnInit {
...
//editorspeech variabel
  ...
  constructor(changeDetectorRef: ChangeDetectorRef, media: MediaMatcher, private fb: FormBuilder, public _sidebarService: SidebarService,
    ...
    public dialogRef: MatDialogRef<JobActivityCreateComponent>, @Inject(MAT_DIALOG_DATA) public data: JobActivityCreateComponent,
    ...
    this.yearFilter = media.matchMedia('(max-width: 1024px)');
      ...
      if(this.activityActionForm=='Add'){
       let TitleName='Interview'
        this.ActivityTitleName=TitleName+'-'+this.Names;
      }
      //this.ActivityTitleName=this.ActivityTitleName+'-'+this.Names;
    ...
    this.myActivityForm = this.fb.group({
      ...
      ActivityTitle: [this.ActivityTitleName, [Validators.required, Validators.maxLength(500)]],/** @When: 30-11-2023 @Who:maneesh for increes charecter length @Why: Ewm-15173 */
      RelatedUserType: ['JOB', [Validators.required]],      /**@When: 16-03-2023 @Who:Renu @Why: EWM-11055 EWM-11090 @What: Activity related to set to employee and iths realted changes */
      RelatedUserTypeName: ['Job'],      /**@When: 16-03-2023 @Who:Renu @Why: EWM-11055 EWM-11090 @What: Activity related to set to employee and iths realted changes */
      ...
      AddRequiredAttendees: [null,[Validators.required]], /** @When: 01-03-2023 @Who:Renu @Why: EWM-10768 EWM-10648 @What: This will also be OPTIONAL Field for a user to create their activity and tasks */
      ...
      IsSendEmailToAttendees: [false],
      IsSendCalendarInviteToAttendees: [true],
      LoggedInUserName: [''],
      TimeZoneID: ['']
    });

    /**@When: 16-03-2023 @Who:Renu @Why: EWM-11055 EWM-11090 @What: Activity related to set to employee and iths realted changes */
    ...
    //  this.dropDownRelatedUserConfig['apiEndPoint'] = this.serviceListClass.getCategoryAll + '?IndustryId=' + IndustryId ;
  ...
  ngOnInit(): void {
        ...
        // who:maneesh,what:ewm-13418 for by default public button patch,when:04/08/2023
  ...
  /*
    ...
    */
    getAllInviteUser() {
      ...
      this.selectedOrganizer = getLoggedInUser
      this.myActivityForm.patchValue({
  ...
  */
  ...
  /*
    ...
    */
    ...
    myActivityJson["RelatedUserTypeName"] = value.RelatedUserTypeName;
    myActivityJson["RelatedUserId"] = value.RelatedUserId;//relatedUserId;
...
*/
  updateActivity(value) { 
   ...
   this.scheduleTimeData.TimeZoneID =  value.TimeZoneID;
    ...
    updateActivityJson["RelatedUserId"] = value.RelatedUserId ;
    ...
    updateActivityJson["IsSendCalendarInviteToAttendees"]=value.IsSendCalendarInviteToAttendees?1:0;
     ...
     updateActivityJson["WorkflowStageId"]=this.WorkFlowStageId;
    ...
    dialogRef.afterClosed().subscribe((res) => {
      if (res.isSchedule == true) {
        ...
        this.utctimezonName = res.scheduleData.TimeZone;
         this.getAvaiableTimeslots(this.slotStartDate);//<!--@suika @EWM-11802 @WHN 11-04-2023 ----->
      }
    })
 ...
 */
  ...
  //     scheduleFormData['TimeEnd']=this.timeAddMinutes(endTime,30); 
  //   }else{
...
/*
  ...
  @When: 24-11-2022
  @Why: EWM-8099
  @What: add removing class from here
*/
// <!--@Who: Bantee Kumar,@When:15-May-2023,@Why:EWM-11943-->
  // showMoreDescription(index){
  //   // let elements = document.getElementById('user-notes-data'+index);
  //   // elements.classList.toggle('user-notes-desc');
  //   var accHD = document.getElementsByClassName('clps-button');
  //     for (let i = 0; i < accHD.length; i++) {
  //         accHD[i].addEventListener('click', this.toggleItem, true);
  //     }
  // }
/*
  @Type: File, <ts>
...
*/
  // toggleItem() {
  //   let Pnode:any = this
  //   var accItem = document.getElementsByClassName('user-main-data');
  //   var itemClass = Pnode.parentNode.className;
  //   for (let i = 0; i < accItem.length; i++) {
  //       accItem[i].className = 'user-main-data close';
  //   }
  //   if (itemClass == 'user-main-data close') {
  //       Pnode.parentNode.className = 'user-main-data user-notes-desc';
  //   }
  // }
    /*
    @Type: File, <ts>
...
patchScheduleData(value) {  
 ...
 },1000) // @suika @EWM-11934 time zone patching in drop down @whn 17-05-2023
           ...
           if (repsonsedata.HttpStatusCode === 200) {   
            ...
            for (let itr2 = 0; itr2 < cceList?.length; itr2++) {
              ...
              'Description': repsonsedata['Data'].TemplateText
               ...
               this.getEditorVal=repsonsedata['Data'].TemplateText   // maneesh EWM-16350 on 27-03-2024 
...
*/
previewEmailPopUp() {
  if (this.myActivityForm.get("Description")?.value==null) { //by maneesh when:04/04/2024
    this.myActivityForm.get("Description")?.value?.setValue('');     
  }
  localStorage.removeItem('selectEmailTemp');
      ...
      .subscribe(
        (data: ResponceData) => {
          if (data.HttpStatusCode === 200) {
            ...
            // @suika @EWM-14-06-2023 @EWM-11584
            ...
            this.getEditorVal= res?.Description; // maneesh EWM-16350 on 27-03-2024 
            ...
            if (res.AttendeesList != '') {
              if (res.AttendeesList.length > 0) {
                ...
                oldAttendeesListValues.forEach((element:any)=>{
                  this.requiredAttendeesList.push({
                    Id: element.Id,
                    Name: element.Name,
                    Email: element.Email,
            ...
            this.onChangeActivityRelatedTo(res.RelatedUserType);
            let regionId = this.timezoneArrList.filter(x => x['Timezone'] == res.ScheduleActivity?.TimeZone);
            this.selecteTimezone = regionId[0];
            this.selectedRelatedUser = { 'Id': res.RelatedUserId, 'Name': res.RelatedUserUserName }//by maneesh ewm-17229 when:10/06/2024
...
*/
  dropdownConfig(){
    this.common_DropdownC_Config = {
      API: this.serviceListClass.getAllJobForActivity,
      MANAGE: './client/core/job/landing',
      BINDBY: 'Name',
      REQUIRED: true,
      DISABLED: false,
