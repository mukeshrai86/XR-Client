...
@Component({
  selector: 'app-applicant-member',
  templateUrl: './applicant-member.component.html',
  styleUrls: ['./applicant-member.component.scss']
})
export class ApplicantMemberComponent implements OnInit{
  loading: boolean;
  candidateInfo: {};
  canFormVal: any;
  ...
  @Input() candidateInfoAction;
  @Output() sendPushApplicantMemberStatus = new EventEmitter<any>();
  constructor( public dialogRef: MatDialogRef<ApplicantMemberComponent>,private pushCandidateEOHService: PushCandidateEOHService,
