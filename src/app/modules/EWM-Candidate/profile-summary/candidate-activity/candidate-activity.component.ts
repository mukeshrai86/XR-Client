/*
  ...
  @What:  This page will be use for Activity for candidate section
*/
 ...
 public plcData = [];
  ...
  ngOnInit(): void {
   ...
   this.myActivityForm = this.fb.group({
    ...
    ActivityTitle: [this.Names, [Validators.required, Validators.maxLength(500)]],/** @When: 28-28-2023 @Who:maneesh for increes charecter length @Why: Ewm-15173 */
    ...
    dialogRef.afterClosed().subscribe(dialogResult => {
      ...
      if (dialogResult == true) {
        ...
        if (viewMode == 'Category') {
          ...
          sessionStorage.removeItem('SelectedCanNotsCatogry');
        }
        if (viewMode == 'Filter') {
          this.filterConfig = [];
        }
  ...
  openDialogJobCategory() {
    ...
    dialogRef.afterClosed().subscribe(result => {      
      if (result!=false ) {
        ...
        sessionStorage.setItem('SelectedCanNotsCatogry',JSON.stringify(result?.selectedOrDeSelected) );
        ...
        this.selectedOrDeSelected=JSON.parse(sessionStorage.getItem('SelectedCanNotsCatogry'));
